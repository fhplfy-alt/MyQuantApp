...
# ==========================================
st.set_page_config(
    page_title="V91 纯净显示版", 
    layout="wide", 
    page_icon="🛡️",
    initial_sidebar_state="expanded"
)

st.title("🛡️ V91 智能量化系统 (纯净显示·零干扰)")
st.caption("✅ 已修复 None 显示问题 | ✅ 界面纯净 | ✅ 全功能内核")
    ...
    def get_deep(_self, code):
        for i in range(5):
            ...
            try:
                ...
                time.sleep(0.5)
            except: _ = bs.logout(); time.sleep(0.5) # 🔥 修复
        return None
