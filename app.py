...
# ==========================================
st.set_page_config(
    page_title="V120 最终稳定版", 
    layout="wide", 
    page_icon="🛡️",
    initial_sidebar_state="expanded"
)

st.title("🛡️ V120 智能量化系统 (独立连接·完整功能)")
st.caption("✅ 修复秒退问题 | ✅ 绿色横幅回归 | ✅ 东方财富实时源")
